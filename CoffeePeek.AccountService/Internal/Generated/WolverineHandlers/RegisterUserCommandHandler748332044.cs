...
{
    // START: RegisterUserCommandHandler748332044
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class RegisterUserCommandHandler748332044 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var registerUserCommand = (CoffeePeek.Account.Application.Features.Auth.RegisterUser.RegisterUserCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "CoffeePeek.Account.Application.Features.Auth.RegisterUser.RegisterUserHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "CoffeePeek.Account.Application.Features.Auth.RegisterUser.RegisterUserHandler");
                
                // The actual message execution
                (var outgoing1, var outgoing2) = await CoffeePeek.Account.Application.Features.Auth.RegisterUser.RegisterUserHandler.Handle(registerUserCommand, queryUserRepository, roleRepository, passwordHasherService, _emailExistenceFilter, unitOfWorkOfAccountDbContext, cancellation).ConfigureAwait(false);
    ...
    // END: RegisterUserCommandHandler748332044
